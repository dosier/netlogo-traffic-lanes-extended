...
to setup
  ...
  ifelse double-lane? [
    ...
    set active-queue south-second-queue ;*
    ask patches [
...
to go
  ...
  [
    ...
    set west-queue make-new-car freq-east min-pxcor -2 90 west-queue ;*
    set south-second-queue make-new-car freq-north 2 min-pycor 0 south-queue ;*
    set west-second-queue make-new-car freq-east min-pxcor 2 90 west-queue ;*
  ]
  [
    set west-queue filter-queue west-queue ;*
    set south-queue filter-queue south-queue ;*
